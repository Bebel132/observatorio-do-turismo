...
class DaoSi {
	...
	//PhpPA
	static function persist(&$obj,$options=[])
	{
	...
	static function getObjById($obj,$id)
	{
	...
	static function getList($obj,$orderby=null,$limit=false)
	{
	...
	static function getTableObj($obj)
	{
